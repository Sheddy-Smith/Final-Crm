...
const LabourForm = ({ labour, onSave, onCancel }) => {
    const [formData, setFormData] = useState(labour || { name: '', phone: '', rate: '', skill: 'Welder', address: '', email: '', creditLimit: 0, openingBalance: 0, openingBalanceDate: new Date().toISOString().split('T')[0], notes: '' });
